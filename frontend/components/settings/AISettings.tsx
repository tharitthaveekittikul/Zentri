  ...
  return (
    <div ref={ref} className="relative">
      <Button
        ...
        onClick={() => setOpen((o) => !o)}
        className={cn(
          "flex w-full items-center justify-between gap-1.5 rounded-lg border border-input bg-transparent h-8 pr-2 pl-2.5 text-sm whitespace-nowrap transition-colors",
